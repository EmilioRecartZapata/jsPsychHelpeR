...
targets <- list(
  ...
  # Use R/prepare_template.R to create new preparation_scripts
   ...
   tar_target(df_CRS, prepare_CRS(DF_clean, short_name_scale_str = 'CRS', output_formats = output_formats)),
   tar_target(df_Goodbye, prepare_Goodbye(DF_clean, short_name_scale_str = 'Goodbye', output_formats = output_formats)),
   tar_target(df_MDDF, prepare_MDDF(DF_clean, short_name_scale_str = 'MDDF', output_formats = output_formats)),
